...
const Data = {
    ...
    portfolio:[
        {
        title:'Сайт для Агенства Недвижимости',
        key:2,
        picture: Realestatesite,
        body:'LoremIpsum'
    },{
        title:'Портал для репортеров',
        key:1,
        picture: ReporterMarketPlace,
        body:'LoremIpsum'
    },
    {
        title:'Сайт для службы доставки пиццы',
        key:3,
        picture: PizzaShop,
        body:'LoremIpsum'
    },
    {
        title:'Сайт для инвестиционного сектора',
        key:4,
        picture: InvestSite,
        body:'LoremIpsum'
    },
    {
        title:'Сайт для финансового сектора',
        key:5,
        picture: FinanceSite,
        body:'LoremIpsum'
    }],
    ...
    about: {
        text:['Алексей Лоян', 'Фронт-Энд Разработчик'],
        buttons:[{
            title:'Резюме',
            href:PDF,
        ...
        contact:['Днепр, Украина','тел: 098-050-63-89','Имейл: alex@loian.dev'],
        qr:QR,
        skills:[
            {
                picture:NodeJS,
