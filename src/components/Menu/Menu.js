...
const dialog = (
    ...
    >
      ...
      <DialogContent>
        ...
        <div style={{display:'flex',flexDirection:'row', justifyContent:'space-around',padding:'10px auto'}}>
        
          
          <Button  variant="contained" color="primary" href="https://github.com/AlexLDP" >GitHub</Button>
          <Button  variant="contained" color="primary" href="https://www.linkedin.com/in/alex-loian-82828284">Linked In</Button>
          <Button  variant="contained" color="primary"  download='Alex-Loian-CV-React-Developer' href={cv}>CV</Button>
          <Button  variant="contained" color="primary"  href='tel:0980506389'>Call</Button>
          <Button  variant="contained" color="primary"
          href="mailto:wisehelper@gmail.com" >Email</Button>
        </div>
