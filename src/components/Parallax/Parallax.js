      ...
      return (
        <Parallax ref={ref => (this.parallax = ref)} pages={4} style={{backgroundColor:'white'}}>
          ...
          <ParallaxLayer offset={1.75} speed={0.5} style={{ opacity: 0.1 }}>
            <img alt="Alex Loian" src={url('cloud')} style={{ display: 'block', width: '20%', marginLeft: '70%' }} />
            <img alt="Alex Loian" src={url('cloud')} style={{ display: 'block', width: '20%', marginLeft: '40%' }} />
          </ParallaxLayer>
  
          <ParallaxLayer offset={1} speed={0.2} style={{ opacity: 0.2 }}>
            <img alt="Alex Loian" src={url('cloud')} style={{ display: 'block', width: '10%', marginLeft: '10%' }} />
